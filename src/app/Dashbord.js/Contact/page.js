            ...
            <div className='flex lg:flex-row flex-col lg:items-center gap-y-[80px]  lg:gap-[100px] lg:mt-[40px] '>
                <div className='flex flex-col lg:gap-[20px] gap-[30px]'>
                    <div className='flex gap-[20px] items-center'>
                        <div>
                            <span className='bg-gradient w-[45px] h-[45px] inline-block text-center text-[25px] rounded-[50px] text-white py-[5px]'><i class="fa fa-phone" aria-hidden="true"></i></span>
                        </div>
                    ...
                    <div className='flex gap-[20px] items-center'>
                        <div>
                            <span className='bg-gradient w-[45px] h-[45px] inline-block text-center text-[25px] rounded-[50px] text-white py-[5px]'> <i class="fa fa-map-marker" aria-hidden="true"></i></span>
                        </div>
                        <div className='flex flex-col gap-y-[3px]'>
                            <p className='text-white font-sans text-[17px] font-medium'>Email</p>
                            <Link href="./" className='text-white font-sans lg:text-[20px] text-[10px] font-bold inline-block'>vaghasiyamanthankumar@gmail.com</Link>
                        </div>
                    </div>
                    ...
                    <div className='flex gap-[20px] items-center'>
                        ...
                        <div className='flex flex-col gap-y-[3px]'>
                            ...
                            <Link href="./" className='text-white font-sans lg:text-[20px] text-[14px] font-bold inline-block max-w-[500px]'>1ST FLOOR B106, SHANTINAGAR SOCIETY HIRABAUG, SURAT CITY, GUJARAT, INDIA</Link>
                        </div>
                    </div>
                </div>
